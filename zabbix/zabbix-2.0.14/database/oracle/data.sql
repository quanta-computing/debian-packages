...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22746','4','{$SNMP_COMMUNITY}','HOST-RESOURCES-MIB::hrStorageDescr','10068','Disk partitions','hrStorageDescr','3600','90','365','0','4','','','0','0','','0','','','1','',NULL,NULL,'','','','0','0','','','','','1','{#SNMPVALUE}:@Storage devices for SNMP discovery',NULL,'','The rule will discover all disk partitions matching the global regexp "Storage devices for SNMP discovery".' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '{$SNMP_COMMUNITY} is a global macro.','0','30')
/
...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22819','0','','','10073','MySQL status','mysql.ping','60','7','365','0','3','','','0','0','','0','','','1','',NULL,'1','','','','0','0','','','','','0','',NULL,'','It requires user parameter mysql.ping, which is defined in userparameter_mysql.conf' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '0 - MySQL server is down' || chr(13) || chr(10) || '1 - MySQL server is up','0','30')
/
...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22829','0','','','10073','MySQL bytes sent per second','mysql.status[Bytes_sent]','60','7','365','0','0','','Bps','0','1','','0','','','1','',NULL,NULL,'','','','0','0','','','','','0','',NULL,'','The number of bytes sent to all clients.' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'It requires user parameter mysql.status[*], which is defined in userparameter_mysql.conf.','0','30')
/

INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22830','0','','','10073','MySQL bytes received per second','mysql.status[Bytes_received]','60','7','365','0','0','','Bps','0','1','','0','','','1','',NULL,NULL,'','','','0','0','','','','','0','',NULL,'','The number of bytes received from all clients. ' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'It requires user parameter mysql.status[*], which is defined in ' || chr(13) || chr(10) || 'userparameter_mysql.conf.','0','30')
/
...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22760','4','{$SNMP_COMMUNITY}','HOST-RESOURCES-MIB::hrStorageDescr','10067','Disk partitions','hrStorageDescr','3600','90','365','0','4','','','0','0','','0','','','1','','22746',NULL,'','','','0','0','','','','','1','{#SNMPVALUE}:@Storage devices for SNMP discovery',NULL,'','The rule will discover all disk partitions matching the global regexp "Storage devices for SNMP discovery".' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '{$SNMP_COMMUNITY} is a global macro.','0','30')
/
...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('22767','4','{$SNMP_COMMUNITY}','HOST-RESOURCES-MIB::hrStorageDescr','10069','Disk partitions','hrStorageDescr','3600','90','365','0','4','','','0','0','','0','','','1','','22746',NULL,'','','','0','0','','','','','1','{#SNMPVALUE}:@Storage devices for SNMP discovery',NULL,'','The rule will discover all disk partitions matching the global regexp "Storage devices for SNMP discovery".' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '{$SNMP_COMMUNITY} is a global macro.','0','30')
/
