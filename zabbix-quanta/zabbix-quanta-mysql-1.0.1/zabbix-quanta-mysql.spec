...
cp -v $RPM_BUILD_DIR/zabbix-quanta-mysql-1.0.1/conf/quanta_mysql.conf $RPM_BUILD_ROOT/etc/zabbix/zabbix_agentd.d/quanta_mysql.conf

%files
%config /etc/zabbix/zabbix_agentd.d/quanta_mysql.conf
